        ...
        <div className="container mx-auto flex min-h-[calc(100vh-200px)] items-center justify-center px-4 py-16">
          <div className="w-full max-w-md space-y-8 rounded-lg bg-white p-8 shadow-lg">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-sm">
                      <Link to="/individual/forgot-password" className="font-medium text-tax-primary hover:text-tax-primary/80">
            ...
            <div className="mt-6 text-center text-sm">
              ...
              <Link to="/individual/signup" className="font-medium text-tax-primary hover:underline">
                Sign up
              </Link>
            </div>
          </div>
